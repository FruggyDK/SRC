...
\begin{document}
	...
	\section{Termodynamiske processor og kredsprocessor}
		%\subsection{Termodynamikkens første hovedsætning}
		\subsection{Termodynamiske processor}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[scale=0.5]{SRC/Billeder/csm_044_PV_diagram_235px_7d08cd8d72}
			...
			\begin{figure}[h!]
				\centerings
				\includegraphics[scale=0.6]{SRC/Billeder/744-9}
				\caption{}
				\label{fig:744-9}
			\end{figure}
